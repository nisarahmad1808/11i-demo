...
@XmlRootElement
public class TemplateFormulation {
	...
	public String toString() {
		return "TemplateFormulation [ext_mapping_id=" + ext_mapping_id + ",ext_mapping_code=" + ext_mapping_code + ",ext_mapping_desc="+ext_mapping_desc+"]";
	}
}
